...
int main() {
    ...
    FILE* answer_data = fopen("cloud.data","rb");
    ...
    //decrypt and rebuild the answer
      ...
      plaintext[j].pregnancies=answer;
      plaintext[j].glucose=answer1;
      plaintext[j].blood_p=answer2;
      plaintext[j].skin_thik=answer3;
      plaintext[j].insulin=answer4;
      plaintext[j].BMI=answer5;
      plaintext[j].diabeties_pedig=answer6;
      plaintext[j].age=answer7;
      plaintext[j].outcome=answer8;
      ...
      printf(" ");
		for(int i=0; i<row_num;i++){
    printf("%d,%d,%d,%d,%d,%d,%d,%d,%d",plaintext[i].pregnancies,plaintext[i].glucose,plaintext[i].blood_p, plaintext[i].skin_thik,plaintext[i].insulin, plaintext[i].BMI,plaintext[i].diabeties_pedig,plaintext[i].age,plaintext[i].outcome);
	  printf(" ");
    }//printf(" completed!! \n");
